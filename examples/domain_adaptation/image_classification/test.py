...
def main(args: argparse.Namespace):
    ...
    new_getter = utils.add_source_validation(utils.get_dataset)

    train_source_dataset, test_source_dataset, train_target_dataset, val_dataset, test_target_dataset, num_classes, args.class_names = \
            new_getter(args.data, args.root, args.source, args.target, train_transform, val_transform)
    ...
    if args.phase == 'test':
        source_accuracy = utils.validate(test_source_loader, classifier, args, device)
        print(source_accuracy)
        target_accuracy = utils.validate(test_target_loader, classifier, args, device)
